...
> **Prerequisite:** Load `auth-and-plans.md` first. RSS feeds are limited on Free/Essential/Standard — unlimited on Pro.
...
| `do_regex` | body | string | No | Regex — only download items matching this |
| `dont_regex` | body | string | No | Regex — skip items matching this |
